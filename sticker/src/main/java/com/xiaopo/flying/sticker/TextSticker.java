...
//    Typeface custom_font = Typeface.createFromAsset(context.getAssets(), "fonts/font2.ttf");
//    Typeface typeface = Typeface.create(custom_font,Typeface.BOLD_ITALIC);
//    textPaint.setTypeface(typeface);
//    textPaint.setShadowLayer(5.0f, 0f, 2.0f, Color.GREEN);
//    textPaint.setShader();
  }
