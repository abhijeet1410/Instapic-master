...
public class PatternAdapter extends RecyclerView.Adapter<PatternAdapter.MyViewHolder> {
    ...
    public PatternAdapter(Activity context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Drawable drawable = Utils.getDrawableFromAsset(mContext, CollageActivity.pattern_images[position]);
        holder.thumbnail.setImageDrawable(drawable);
    }

    @Override
    public int getItemCount() {
        return CollageActivity.pattern_images.length;
    }
