...
public class FrameAdapter extends RecyclerView.Adapter<FrameAdapter.MyViewHolder> {
    ...
    public FrameAdapter(Activity context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Drawable drawable = Utils.getDrawableFromAsset(mContext, CollageActivity.frame_images[position]);
        holder.thumbnail.setImageDrawable(drawable);
    }

    @Override
    public int getItemCount() {
        return CollageActivity.frame_images.length;
    }
