...
public class EffectAdapter extends RecyclerView.Adapter<EffectAdapter.MyViewHolder> {
    ...
    public void setData(String[] effect_images){
        this.effect_images = effect_images;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_hoarding_effect, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Drawable drawable = Utils.getDrawableFromAsset(mContext, effect_images[position]);
        holder.thumbnail.setImageDrawable(drawable);
    }

    @Override
    public int getItemCount() {
        return effect_images.length;
    }
